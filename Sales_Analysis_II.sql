...
- The buyer with id 2 didn't buy an S8.
- The buyer with id 3 bought both an S8 and an iPhone.
Therefore, only buyer 1 should be reported.
================================================================================
*/
-- Your 100% Correct Solution:
WITH jointable AS (
    SELECT p.product_name, s.buyer_id 
    FROM Product p 
